...
For the first plot, we cleaned the values under variables using the `case_when` function and used `factor` to level categorical ordinal variables, physical health and mental health, in decreasing order. We then created a scatter plot showing the concentration of responses according to dot size.
