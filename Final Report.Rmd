...
(DELETING THIS GRAPH?) For the second plot we renamed the loneliness variable so that it was consistent across the three waves and then merged the three waves of data by ID. Again, we used `case_when` to clean the values under the variables of interest. We then created a spaghetti plot to show the change in loneliness across waves.
...
In this code chunk we created a dataset containing baseline values and then

Discussion:

We anticipated that those who felt they had good physical health would also have good mental health and vice versa. From Graph 1
