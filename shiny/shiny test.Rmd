...
## Clean self-rated physical health 
...
## Clean self-rated mental health 
...
plot_3 = baseline_loneliness_0 %>% 
  ...
  geom_smooth(data = baseline_loneliness_1, aes(x = wave, y = loneliness_value), se = FALSE, color = "#6AF00") +
