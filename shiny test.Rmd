...
## Functions for cleaning variables
...
## Assign data from each wave to a new object with common variable names given unique names
...
## Combine data for self-report physical and mental health, create consistent, clean labels for variables, 
## and reorder factor variables in a reasonable order
