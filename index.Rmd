...
To access a screencast overview of our project on this website please see the attached YOUTUBE link.
<br>
<br>
<center>
<b>
...
The Irish Longitudinal Study on Ageing (TILDA) was used for this analysis. Follow this link to the [Dataset](https://deg2163.github.io/p8105_tilda.github.io/about.html) tab to learn more.
<br>
<br>
<center>
<b>
...
<br>
&emsp; - The [Shiny Data Analysis](https://clc2229.shinyapps.io/shiny_analysis/) tab contains an interactive scatter plot of our results as well as a chi-squared test.
<br>
<br>
Does loneliness change over time? Stratified by sex and marital status?
<br>
&emsp;- The [Shiny Data Visualizations](https://clc2229.shinyapps.io/shiny_test/) tab contains our results in an interactive spaghetti plot.
<br>
<br>
What is the proportion of various ICD-10 diseases among this population in wave 3? Stratified by sex and marital status.
<br>
&emsp;- The [Shiny Data Visualizations](https://clc2229.shinyapps.io/shiny_test/) tab contains our results in an interactive bar chart.
<br>
<br>
<center>
<b>
...
<br>
<br>
&emsp; 1. Those who felt they had good physical health also had good mental health and vice versa. We also found a larger concentration of older adults reporting "Very Good" or "Good" physical and mental health. This trend remained consistent across sex and over time. Unfortunately, this means that there was minimal improvement in physical and mental health, but also minimal decline in physical and mental health. TALK ABOUT CHI SQUARED TEST
<br>
<br>
