...
<br>
&emsp; - The LINK TO ANALYSIS DASHBOARD tab contains an interactive scatter plot of our results as well as a chi-squared test.
/&emsp;
<br>
<br>
Does loneliness change over time? Stratified by sex and marital status?
<br>
&emsp;- The LINK TO SHINY DASHBOARD tab contains our results in an interactive spaghetti plot.
/&emsp;
<br>
<br>
What is the proportion of various ICD-10 diseases among this population in wave 3? Stratified by sex and marital status.
<br>
&emsp;- The LINK TO SHINY DASHBOARD tab contains our results in an interactive bar chart.
/&emsp;
<br>
<br>
<center>
