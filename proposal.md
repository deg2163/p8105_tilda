...
-   Will look at key indicators such as: age(AGE), employment status(WE001), sex(SEX), retired status, activity group participation, marital status (CS006), education (DM001), and number of close relatives or friends
